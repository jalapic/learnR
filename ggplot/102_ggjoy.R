## ggridgelines - multiple density plots
...
ggplot(iris, aes(x = Sepal.Length, y = Species)) + geom_density_ridges2()  #slightly nicer imo
...
ggplot(iris, aes(x = Sepal.Length, y = Species_num, group = Species_num)) + geom_density_ridges2()

# cut off trailing tails
ggplot(iris, aes(x = Sepal.Length, y = Species)) + geom_density_ridges2(rel_min_height = 0.01)
